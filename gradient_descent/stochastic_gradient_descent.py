"""
Stochastic gradient descent computes the gradient (and takes a step) for only 
one point at a time. It cycles over the data repeatedly until it reaches a stopping 
point
"""
